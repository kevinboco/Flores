  ...
  <div style="text-align:center; margin-bottom: 20px;">
    ...
    <div id="filtroPrecio" style="display: none; margin-top: 20px;">
      <form method="GET">
        ...
        <?php endif; ?>
        <label>Precio mínimo: <span id="minValor"><?= $_GET['min'] ?? 0 ?></span></label><br>
        <input type="range" name="min" id="min" min="0" max="100000" step="1000" value="<?= $_GET['min'] ?? 0 ?>" oninput="minValor.textContent = this.value"><br><br>
        <label>Precio máximo: <span id="maxValor"><?= $_GET['max'] ?? 100000 ?></span></label><br>
        <input type="range" name="max" id="max" min="0" max="100000" step="1000" value="<?= $_GET['max'] ?? 100000 ?>" oninput="maxValor.textContent = this.value"><br><br>
    ...
    ?>
      <div class="card" data-aos="fade-up">
        ...
        <div class="info">
          ...
          <button onclick="togglePersonalizar(this)" class="boton-whatsapp" style="background:#ffc107;">✨ Personalizar</button>
          ...
          <div class="personalizacion" style="display:none; margin-top: 10px; font-size:14px;">
            ...
            <label>Cinta personalizada(+7000): <input type="text" placeholder="Escribe un mensaje..."></label><br><br>
